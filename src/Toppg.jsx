...
export default function Toppg() {
  return (
    <div className='Toppg relative w-full h-[35vh] nnn '>
      <img src='src\favicon.jpg' className='absolute logo h-[150px] left-[20vw] top-[40px] ii'></img>

        <div id="hding" className=' w-[60%] flex-col h-[80%]  nnn'>
            <div className='text-9xl mainhid font-[500] txt font-[fantasy]'>Crypto-Verse</div>
